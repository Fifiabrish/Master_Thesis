\section{مبانی نظریه اطلاعات و \f-واگرایی‌ها}
...
تابع $f$ «ژنراتور» (تولیدکننده)ی واگرایی نامیده می‌شود و با انتخاب $f$های متفاوت، می‌توان معیارهای فاصله یا واگرایی متفاوتی را به دست آورد.
...
یکی از مشهورترین این روابط، نامساوی پینسکر\LTRfootnote{Pinsker's Inequality} است که ارتباط بین واگرایی \lr{KL} و فاصله‌ی واریانس کل را نشان می‌دهد:
\begin{equation}
\label{eq:pinsker}
...
در فصل بعدی، ما به تفصیل بررسی خواهیم کرد که چگونه تضمین \LDP (که در معادله \ref{eq:ldp} تعریف شد) مستقیماً منجر به ایجاد یک کران بالا بر روی \f-واگرایی‌های مختلف بین توزیع‌های خروجی می‌شود.