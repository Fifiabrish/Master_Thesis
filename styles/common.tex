...
% یا
\usepackage{url}
% پکیج اصلی برای رسم نمودارها
\usepackage{tikz}

% کتابخانه‌های مورد نیاز TikZ برای اشکال هندسی، مکان‌یابی و لایه‌بندی
\usetikzlibrary{shapes.geometric, positioning, fit, backgrounds}

% پکیج مورد نیاز برای نمایش شکلک (smiley) در نمودارها
\usepackage{wasysym}
...
\NewDocumentCommand{\Yset}{o}{%
  \IfValueTF{#1}%
    {\ensuremath{\mathcal{Y}_{#1}}}%
